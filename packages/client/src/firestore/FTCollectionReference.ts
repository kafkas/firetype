import { FTCollectionReferenceCore, FTModel, FTCollectionModel } from '@firetype/core';
...
export class FTCollectionReference<CM extends FTCollectionModel> extends FTCollectionReferenceCore<'client', CM> {
  constructor(
    public readonly core: firebase.firestore.CollectionReference<FTModel.Processed<CM>>,
